...
const CACHE = 'mi-cartera-v68';
const ASSETS = [
  './', 'index.html', 'css/styles.css', 'js/data.js', 'js/store.js', 'js/app.js', 'js/calculadora.js', 'js/vehicular.js', 'js/propuesta-pdf.js', 'js/gerente.js', 'js/vendor/jspdf.umd.min.js', 'js/firebase-config.js', 'js/nube.js',
